...
def _load_campaign_run(run_dir: Path) -> dict[str, Any]:
    ...
    runtime_environment = _dict(managed_run.get("runtime_environment")) or _dict(recommendation_payload.get("runtime_environment"))
    client_saturation = _dict(managed_run.get("client_saturation"))
    load_sufficiency = _dict(managed_run.get("load_sufficiency"))
    run = {
        "run_dir": str(run_dir),
        ...
        "backend_version": runtime_environment.get("backend_version") or _dict(managed_run.get("backend_metadata")).get("version"),
        "model": managed_run.get("model") or selected.get("model") or selected_row.get("model"),
        ...
        "cuda_runtime_version": runtime_environment.get("cuda_runtime_version"),
        "gpu_driver_version": runtime_environment.get("gpu_driver_version"),
        "runtime_environment_fingerprint": runtime_environment.get("environment_fingerprint"),
        ...
        "output_tokens_per_sec": _first_float(metrics.get("output_tokens_per_sec"), selected_row.get("output_tokens_s")),
        "total_tokens_per_sec": _first_float(metrics.get("total_tokens_per_sec"), selected_row.get("total_tokens_s")),
        "request_rate_req_s": _first_float(metrics.get("request_rate_req_s"), selected_row.get("request_rate_req_s")),
        "p95_latency_ms": _first_float(metrics.get("p95_latency_ms"), _seconds_to_ms(selected_row.get("p95_latency_s"))),
        "p95_ttft_ms": _first_float(metrics.get("p95_ttft_ms"), selected_row.get("p95_ttft_ms"), selected_row.get("ttft_ms")),
        "p95_tpot_ms": _first_float(metrics.get("p95_tpot_ms"), selected_row.get("p95_tpot_ms"), selected_row.get("tpot_ms")),
        ...
        "joules_per_generated_token": _first_float(metrics.get("joules_per_generated_token"), selected_row.get("joules_per_generated_token")),
        "tokens_per_joule": _first_float(metrics.get("tokens_per_joule"), selected_row.get("tokens_per_joule")),
        "tokens_per_watt": _first_float(metrics.get("tokens_per_watt"), selected_row.get("tokens_per_second_per_watt")),
        "energy_accounting": metrics.get("energy_accounting") or selected_row.get("energy_accounting"),
        ...
        "load_sufficiency_classification": load_sufficiency.get("classification"),
            ...
            writer.writerow(
                {
                    ...
                    "runtime_environment_fingerprint": row.get("runtime_environment_fingerprint"),
                    ...
                    "request_rate_req_s": row.get("request_rate_req_s"),
                    "p95_latency_ms": row.get("p95_latency_ms"),
                    "p95_ttft_ms": row.get("p95_ttft_ms"),
                    "p95_tpot_ms": row.get("p95_tpot_ms"),
                    "average_power_w": row.get("average_power_w"),
                    "joules_per_token": row.get("joules_per_token"),
                    "joules_per_generated_token": row.get("joules_per_generated_token"),
                    "tokens_per_joule": row.get("tokens_per_joule"),
                    "tokens_per_watt": row.get("tokens_per_watt"),
                    "energy_accounting": row.get("energy_accounting"),
                    "telemetry_quality": row.get("telemetry_quality"),
                    "client_saturation_classification": row.get("client_saturation_classification"),
                    "load_sufficiency_classification": row.get("load_sufficiency_classification"),
